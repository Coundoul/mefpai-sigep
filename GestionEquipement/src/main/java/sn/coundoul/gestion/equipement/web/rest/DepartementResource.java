...
import sn.coundoul.gestion.equipement.repository.DepartementRepository;
...
/**
 * REST controller for managing {@link sn.coundoul.gestion.equipement.domain.Departement}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class DepartementResource {
    ...
    private static final String ENTITY_NAME = "gestionEquipementDepartement";
