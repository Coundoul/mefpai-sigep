...
/**
 * REST controller for managing {@link sn.coundoul.gestion.equipement.domain.Fournisseur}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class FournisseurResource {
    ...
    private static final String ENTITY_NAME = "gestionEquipementFournisseur";
