...
import sn.coundoul.gestion.equipement.repository.QuartierRepository;
...
/**
 * REST controller for managing {@link sn.coundoul.gestion.equipement.domain.Quartier}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class QuartierResource {
    ...
    private static final String ENTITY_NAME = "gestionEquipementQuartier";
