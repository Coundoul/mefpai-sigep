...
describe('Component Tests', () => {
  describe('Magazin Management Component', () => {
    let comp: MagazinComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MagazinComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.magazins?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
