...
export class ListProjetsAllComponent implements OnInit {
  ...
  delete(projets: IProjets): void {
    const modalRef = this.modalService.open(ProjetsDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.projets = projets;
  ...
  protected onSuccess(data: IProjets[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
