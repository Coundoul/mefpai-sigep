...
describe('Component Tests', () => {
  describe('Detenteur Management Component', () => {
    let comp: DetenteurComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DetenteurComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.detenteurs?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
