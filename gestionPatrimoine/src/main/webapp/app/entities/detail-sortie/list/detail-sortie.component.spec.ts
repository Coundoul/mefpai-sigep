...
describe('Component Tests', () => {
  describe('DetailSortie Management Component', () => {
    let comp: DetailSortieComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DetailSortieComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.detailSorties?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
