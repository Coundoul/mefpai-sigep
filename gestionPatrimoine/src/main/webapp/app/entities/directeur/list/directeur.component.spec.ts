...
describe('Component Tests', () => {
  describe('Directeur Management Component', () => {
    let comp: DirecteurComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DirecteurComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.directeurs?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
