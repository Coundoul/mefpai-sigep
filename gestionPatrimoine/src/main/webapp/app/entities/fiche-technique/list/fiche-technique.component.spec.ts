...
describe('Component Tests', () => {
  describe('FicheTechnique Management Component', () => {
    let comp: FicheTechniqueComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FicheTechniqueComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.ficheTechniques?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
