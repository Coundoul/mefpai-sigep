...
export class IntervenantComponent implements OnInit {
  ...
  trackId(index: number, item: IIntervenant): number {
    return item.id!;
  }

  delete(intervenant: IIntervenant): void {
  ...
  protected onSuccess(data: IIntervenant[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
