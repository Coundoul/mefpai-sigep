...
export class RegionService {
  public resourceUrl = this.applicationConfigService.getEndpointFor('api/equipements/regions', 'gestionequipement');
...
Injectable({ providedIn: 'root' })
export class RegionServiceInfra {
  public resourceUrl = this.applicationConfigService.getEndpointFor('api/infrastructures/regions', 'gestioninfrastructure');
