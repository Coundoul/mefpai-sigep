...
export class TechnicienComponent implements OnInit {
  ...
  trackId(index: number, item: ITechnicien): number {
    return item.id!;
  }

  delete(technicien: ITechnicien): void {
    const modalRef = this.modalService.open(TechnicienDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: ITechnicien[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
