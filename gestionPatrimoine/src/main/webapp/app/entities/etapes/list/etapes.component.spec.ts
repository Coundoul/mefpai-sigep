...
describe('Component Tests', () => {
  describe('Etapes Management Component', () => {
    let comp: EtapesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EtapesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.etapes?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
