...
describe('Component Tests', () => {
  describe('Intendant Management Component', () => {
    let comp: IntendantComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(IntendantComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.intendants?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
