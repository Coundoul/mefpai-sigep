...
describe('Component Tests', () => {
  describe('ChefProjet Management Component', () => {
    let comp: ChefProjetComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ChefProjetComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.chefProjets?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
