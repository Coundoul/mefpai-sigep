...
export class DetenteurComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-detenteur div table .btn-danger'));
  title = element.all(by.css('jhi-detenteur div h2#page-heading span')).first();
...
export class DetenteurUpdatePage {
  pageTitle = element(by.id('jhi-detenteur-heading'));
...
export class DetenteurDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-detenteur-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-detenteur'));
