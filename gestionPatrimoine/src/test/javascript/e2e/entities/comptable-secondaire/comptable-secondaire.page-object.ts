...
export class ComptableSecondaireComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-comptable-secondaire div table .btn-danger'));
  title = element.all(by.css('jhi-comptable-secondaire div h2#page-heading span')).first();
...
export class ComptableSecondaireUpdatePage {
  pageTitle = element(by.id('jhi-comptable-secondaire-heading'));
...
export class ComptableSecondaireDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-comptableSecondaire-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-comptableSecondaire'));
