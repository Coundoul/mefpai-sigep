...
export class DirecteurComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-directeur div table .btn-danger'));
  title = element.all(by.css('jhi-directeur div h2#page-heading span')).first();
...
export class DirecteurUpdatePage {
  pageTitle = element(by.id('jhi-directeur-heading'));
...
export class DirecteurDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-directeur-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-directeur'));
