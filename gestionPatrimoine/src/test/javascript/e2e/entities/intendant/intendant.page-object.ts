...
export class IntendantComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-intendant div table .btn-danger'));
  title = element.all(by.css('jhi-intendant div h2#page-heading span')).first();
...
export class IntendantUpdatePage {
  pageTitle = element(by.id('jhi-intendant-heading'));
...
export class IntendantDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-intendant-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-intendant'));
