...
export class ChefMaintenanceComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-chef-maintenance div table .btn-danger'));
  title = element.all(by.css('jhi-chef-maintenance div h2#page-heading span')).first();
...
export class ChefMaintenanceUpdatePage {
  pageTitle = element(by.id('jhi-chef-maintenance-heading'));
...
export class ChefMaintenanceDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-chefMaintenance-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-chefMaintenance'));
