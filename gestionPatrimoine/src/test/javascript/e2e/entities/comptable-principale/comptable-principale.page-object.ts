...
export class ComptablePrincipaleComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-comptable-principale div table .btn-danger'));
  title = element.all(by.css('jhi-comptable-principale div h2#page-heading span')).first();
...
export class ComptablePrincipaleUpdatePage {
  pageTitle = element(by.id('jhi-comptable-principale-heading'));
...
export class ComptablePrincipaleDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-comptablePrincipale-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-comptablePrincipale'));
