...
export class ChefProjetComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-chef-projet div table .btn-danger'));
  title = element.all(by.css('jhi-chef-projet div h2#page-heading span')).first();
...
export class ChefProjetUpdatePage {
  pageTitle = element(by.id('jhi-chef-projet-heading'));
...
export class ChefProjetDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-chefProjet-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-chefProjet'));
