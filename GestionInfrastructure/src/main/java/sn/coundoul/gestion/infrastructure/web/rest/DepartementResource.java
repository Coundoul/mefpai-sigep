...
import sn.coundoul.gestion.infrastructure.repository.DepartementRepository;
...
/**
 * REST controller for managing {@link sn.coundoul.gestion.infrastructure.domain.Departement}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class DepartementResource {
    ...
    private static final String ENTITY_NAME = "gestionInfrastructureDepartement";
