...
/**
 * REST controller for managing {@link sn.coundoul.gestion.infrastructure.domain.Etablissement}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EtablissementResource {
    ...
    private static final String ENTITY_NAME = "gestionInfrastructureEtablissement";
    ...
    public ResponseEntity<List<Etablissement>> getAllEtablissements(Pageable pageable) {
        ...
        Page<Etablissement> page = etablissementRepository.findAll(pageable);
