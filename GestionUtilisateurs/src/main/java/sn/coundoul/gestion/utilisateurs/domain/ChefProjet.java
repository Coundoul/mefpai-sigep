...
public class ChefProjet implements Serializable {
    ...
    public ChefProjet nomPers(String nomPers) {
    ...
    public ChefProjet prenomPers(String prenomPers) {
    ...
    public ChefProjet sexe(Sexe sexe) {
        this.sexe = sexe;
        return this;
    }
    ...
    public ChefProjet mobile(String mobile) {
        this.mobile = mobile;
        return this;
    }
    ...
    public ChefProjet adresse(String adresse) {
    ...
    public ChefProjet direction(Direction direction) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChefProjet)) {
            return false;
        }
        return id != null && id.equals(((ChefProjet) o).id);
    }
